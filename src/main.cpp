...
MacropadState default_state(button_any, load_teams_state, load_generic_state, load_brightness_adjustment_state, build_link_macro, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, nullptr, encoder_handler, encoder_pressed, oled_draw);
...
{
	static MacropadState brightnessAdjustState(&default_state, nullptr,
	...
	if (falling) {
		brightnessAdjustState.set_encoder_position(macropad.get_encoder_position());
